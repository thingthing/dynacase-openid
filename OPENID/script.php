(function () {
	function gen_selector() {
		...
		var s;
		var providers = [{longname: "myOpenID", shortname: "myOpenID", url_suffix: ".myopenid.com/", usercalled: "username", icon: "myopenid.ico", id: 8, website: "https://www.myopenid.com/", openid1: true, url_prefix: "http://", openid2: true},]
		...
		s.width = '200px'; s.height = '0px'; s.margin = '0px'; s.padding = '0px'; s.zIndex = 10000;
		s.border = '0px';
		...
		function Cell(grid, idx) {
			...
			icon.src = provider ? ('OPENID/Images/' + provider.icon) :
                'OPENID/Images/openid.ico';
			icon.style.width = "16px";
			icon.style.height = "16px";
			icon.style.verticalAlign = "middle";
			td.appendChild(icon);
			td.appendChild(pdoc.createTextNode(" "));
			td.appendChild(pdoc.createTextNode(provider ? provider.shortname : "An other OpenID"));
		...
		_.select = function (cell) {
			...
			if (cell.idx > -1) {
				...
				nameLabel.style.visibility = 'hidden';
				nameTb.style.visibility = 'hidden';
				btnIcn.src = 'OPENID/Images/openid.ico';
			}
		}
